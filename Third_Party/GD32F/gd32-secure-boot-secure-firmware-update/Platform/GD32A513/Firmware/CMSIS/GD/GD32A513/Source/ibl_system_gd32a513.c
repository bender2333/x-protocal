 ...
 * See the License for the specific language governing permissions and 5 
...
*/
uint32_t gd32a513_firmware_version_get(void)
{
    return __GD32A513_STDPERIPH_VERSION;
}
