...
#if defined(MCUBOOT_USE_IBL_VERIFY_SIGN)
#undef BOOTUTIL_CRYPTO_RSA_SIGN_ENABLED
#endif
...
#ifndef MCUBOOT_USE_IBL_VERIFY_SIGN
/*
...
out:
    ...
    rc = ibl_img_verify_sign(hash, hlen, pubkey, sig);
    if (rc) {
        fih_rc = FIH_FAILURE;
    } else {
        fih_rc = FIH_SUCCESS;
