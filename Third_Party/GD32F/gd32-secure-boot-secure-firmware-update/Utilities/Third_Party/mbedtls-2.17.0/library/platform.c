...
static void * (*mbedtls_calloc_func)( size_t, size_t );
static void (*mbedtls_free_func)( void * );

void * mbedtls_calloc( size_t nmemb, size_t size )
{
	if (mbedtls_calloc_func)
...
#ifdef MBEDTLS_ROM_TEST
mbedtls_time_t (*mbedtls_time_func)( mbedtls_time_t* timer );
mbedtls_time_t mbedtls_time( mbedtls_time_t* timer )
{
	if (mbedtls_time_func)
    	return (*mbedtls_time_func)( timer );
	else {
		mbedtls_printf("!!!!!!mbedtls_time(): return 0\r\n");
		return 0;
	}
}
