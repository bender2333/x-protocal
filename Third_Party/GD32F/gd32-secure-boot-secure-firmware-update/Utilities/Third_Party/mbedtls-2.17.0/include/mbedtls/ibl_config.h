 ...
 */
#if (SIGN_ALGO_SET != IMG_SIG_ECDSA256) && defined(CONFIG_HW_LIMITED_SIZE)
//#define MBEDTLS_ECDSA_C
#else
#define MBEDTLS_ECDSA_C
#endif /* (SIGN_ALGO_SET != IMG_SIG_ECDSA256) && defined(CONFIG_HW_LIMITED_SIZE) */
 ...
 */
#if defined(CONFIG_HW_LIMITED_SIZE)
#if defined(MBEDTLS_ECDSA_C)
#define MBEDTLS_ECP_C
#endif /* MBEDTLS_ECDSA_C */
#else
#define MBEDTLS_ECP_C
#endif /* CONFIG_HW_LIMITED_SIZE */
...
#else
#define MBEDTLS_CIPHER_MODE_CFB
#endif /* defined(CONFIG_HW_LIMITED_SIZE) */
 ...
 */
#if defined(CONFIG_HW_LIMITED_SIZE)
#if defined(MBEDTLS_ECP_C) || (SIGN_ALGO_SET == IMG_SIG_RSA2048)
 ...
 */
#if (SIGN_ALGO_SET != IMG_SIG_RSA2048) && defined(CONFIG_HW_LIMITED_SIZE)
...
#include "Utilities/Third_Party/mbedtls-2.17.0/include/mbedtls/check_config.h"
